    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:bg-transparent flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:gap-2"
        >
          {children}
        </div>
      </div>
